...
#file_names_tumor = ['/Users/dasha/PhD/results-1107/all_valid_wt_model.txt']
file_names_tumor = ['/Users/dasha/PhD/results_3_tools/all_pe_with_models.txt']
file_names_tumor = ['/Users/dasha/PhD/results_3_tools/all_valid_wt_model_mp.txt']
#file_names_tumor = ['/Users/dasha/PhD/sv-bay-ga/valid_links_test/chr8_chr8_valid_links_41.txt']
#file_names_tumor = glob.glob(config['working_dir'] + config['valid_links_dir'] + '*.txt')
#file_names_tumor = ['/Users/dasha/PhD/results_3_tools/Assembled_pe_sv_bay']
#file_names_tumor = ['/Users/dasha/PhD/results_3_tools/ga_noDup/ga_all_valid_wt_model.txt']
...
file_names_normal =['/Users/dasha/PhD/results_3_tools/all_norm_mp.txt']
if file_names_normal:
	#file_names_normal_dir = open(config['working_dir']+file_names_normal)
	file_names_normal_dir = open(file_names_normal[0])
else:
	file_names_normal =[]
links_normal=[]
...
coamplf_lagre_dupl = [link for link in links if link.gamma_alelles > 8 ]
